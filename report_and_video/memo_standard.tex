...
\item \term{Calibration:} every raw model under-predicts PD because the 2015 vintage defaulted more than the training years. Isotonic recalibration on 2014 removes most of the bias but cannot anticipate drift not yet visible in 2014. The scorecard has the best raw calibration (ECE 0.0246), and after recalibration it and the MLP are indistinguishable (0.0175 and 0.0172, within seed noise), both ahead of the trees (0.0214 and 0.0218); the trees keep the better Brier because Brier also rewards ranking.
